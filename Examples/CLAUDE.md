...
- **Entitlements File**: `Config/GenerativeUIDemo.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/GenerativeUIDemo.entitlements`:
...
// In your app
@main
struct GenerativeUIDemoApp: App {
    var body: some Scene {
        WindowGroup {
            ContentView()
