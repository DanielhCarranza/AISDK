...
//  Defines available UI components for LegacyLLM prompt generation
//
...
/// Protocol defining a UI component that can be generated by LegacyLLM
///
/// Each component definition describes:
/// - The component type name (used in JSON)
/// - Human-readable description for the LegacyLLM
...
public protocol UIComponentDefinition: Sendable {
    ...
    /// Human-readable description for the LegacyLLM prompt
    static var description: String { get }

    /// Whether this component can contain children
    static var hasChildren: Bool { get }

    /// Human-readable description of the props schema for LegacyLLM
...
public struct AnyUIComponentDefinition: Sendable {
    ...
    /// Props schema description for LegacyLLM
...
/// Component catalog defining available UI components for LegacyLLM
///
...
/// - System prompt generation for LegacyLLM context
///
/// ## Usage
/// ```swift
...
///
/// // Generate system prompt for LegacyLLM
...
public struct UICatalog: Sendable {
    ...
    /// Generate a system prompt describing available components for LegacyLLM
    ///
    /// This prompt can be included in the system message to inform the LegacyLLM
