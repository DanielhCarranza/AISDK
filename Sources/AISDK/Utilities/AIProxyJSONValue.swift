...
public enum AIProxyJSONValue: Codable, @unchecked Sendable {
    case null(NSNull)
    case bool(Bool)
    case int(Int)
    case double(Double)
...
// MARK: - AIProxyJSONValue Extensions
...
extension AIProxyJSONValue {
    ...
    /// Convert to untyped dictionary for compatibility (only for object cases)
...
extension [String: AIProxyJSONValue] {
    ...
    /// Alternative method for deserialization
