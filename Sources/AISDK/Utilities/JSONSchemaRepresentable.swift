...
// MARK: - AIProxyJSONValue Type
/// A type that can represent any JSON value, used for dynamic JSON content
public enum AIProxyJSONValue: Codable {
    ...
    /// Convert to untyped dictionary for compatibility
...
// Extension to support deserialization from dictionary
extension Dictionary where Key == String, Value == AIProxyJSONValue {
    public func deserialize(from data: Data) throws -> [String: AIProxyJSONValue] {
