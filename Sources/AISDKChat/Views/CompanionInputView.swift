...
///
/// ```swift
/// struct CompanionMessageInputTestView: View {
...
/// }
/// ```
public struct CompanionMessageInputView: View {
    ...
    public var body: some View {
        HStack(alignment: .bottom) {    // swiftlint:disable:this closure_body_length
            ...
            .preference(key: MessageInputViewHeightKey.self, value: messageViewHeight)
            #if os(macOS)
            .onSubmit {
            ...
            .sheet(isPresented: $showingAttachmentMenu) {
                AttachmentMenuView(
                    ...
                    onPhotosSelected: {
                        // TODO: Implement photos action
                    },
                    onFilesSelected: {
                        // TODO: Implement files action
                    }
                )
...
#Preview {
    ...
    return ZStack {
        ...
        VStack {
            MessagesView($chat)
            CompanionMessageInputView($chat)
        }
            .onPreferenceChange(MessageInputViewHeightKey.self) { newValue in
